    ...
    with open(data_file, "r", errors="ignore") as f:
        for line in f:
            ...
            if idx % sample_step_size == 0:
                print(
                    f"Process {round(idx/sample_window_size * 100,4)} % raw data",
                    end="\r",
                )
...
if __name__ == "__main__":
    data_dir = os.path.expanduser(
        "/home/ssakurai/project/log/dataset/loghub/Thunderbird/"
    )
    output_dir = "/home/ssakurai/project/log/dataset/preprocessed/TBird/"
    ...
    #########
    # sample_raw_data(
    #     data_dir + raw_log_file,
    #     data_dir + sample_log_file,
    #     sample_window_size,
    #     sample_step_size,
    # )
    ...
    # Parser #
    #########
    # parse_log(data_dir, output_dir, raw_log_file, parser_type)

    ##################
    # Transformation #
    ##################
    df = pd.read_csv(f"{output_dir}{raw_log_file}_structured.csv")
    ...
    deeplog_file_generator(os.path.join(output_dir, "all"), train, ["EventId"])
