...
from logbert.model.deeplog.lstm import *
...
if __name__ == "__main__":
    ...
    predict_parser.add_argument(
        "--mean", type=float, default=0, help="error gaussian distribution mean"
    )
    predict_parser.add_argument(
        "--std", type=float, default=0, help="error gaussian distribution std"
    )
