...
class Trainer:
    def __init__(self, model, options):
        ...
        if self.sample == "sliding_window":
            ...
            train_logs, train_labels = session_window(self.output_dir, datatype="train")
            val_logs, val_labels = session_window(self.output_dir, datatype="val")
        else:
        ...
        print(
            "Find %d train logs, %d validation logs"
