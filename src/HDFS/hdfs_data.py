...
input_dir = os.path.expanduser("/home/ssakurai/project/log/dataset/loghub/HDFS/")
output_dir = "/home/ssakurai/project/log/dataset/preprocessed/HDFS/"  # The output directory of parsing results
...
def generate_train_test(hdfs_sequence_file):
    ...
    seq["Label"] = seq["BlockId"].apply(
        lambda x: blk_label_dict.get(x)
    )  # add label to the sequence of each blockid
    ...
    df_to_file(train, output_dir + "all")
    # df_to_file(test_normal, output_dir + "test_normal6")
    ...
    # df_to_file(train, output_dir + "train6")
    # df_to_file(test_normal, output_dir + "test_normal4")
    # print("generate train test data done")
    ...
    # df_to_file(train, output_dir + "train8")
    # df_to_file(test_normal, output_dir + "test_normal2")
    # print("generate train test data done")
