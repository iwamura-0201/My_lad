...
UNK = 1
START = 2
data_dir = os.path.expanduser("/home/ssakurai/project/log/dataset/amiya/WEB1/")
output_dir = "/home/ssakurai/project/log/dataset/preprocessed/WEB1_4/"
log_file = "WEB1_4.csv"
...
def prepre(csv_path):
    ...
    data = pd.read_csv(
        "/home/ssakurai/project/log/dataset/amiya/WEB1/filtered_output.csv"
    )

    # 一致した行の行番号を保存するリスト
    matched_indices = [333101, 333936, 333940, 333942, 333943]
