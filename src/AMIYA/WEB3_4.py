...
output_dir = "/home/ssakurai/project/log/dataset/preprocessed/WEB3_4/"
log_file = "WEB3_4.csv"
...
def prepre(csv_path):
    ...
    data = pd.read_csv(
        "/home/ssakurai/project/log/dataset/amiya/WEB3/filtered_output.csv"
    )

    # 一致した行の行番号を保存するリスト
    matched_indices = [332810, 332907, 333001, 332910, 331911, 333060]
